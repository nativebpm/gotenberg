...
func (r *Chromium) ConvertHTML(ctx context.Context, html io.Reader) *Chromium {
	r.Req = r.Client.MultipartRequest(ctx, httpclient.POST, "/forms/chromium/convert/html").File("files", "index.html", html)
	return r
}
...
func (r *Chromium) ConvertURL(ctx context.Context, url string) *Chromium {
	r.Req = r.Client.MultipartRequest(ctx, httpclient.POST, "/forms/chromium/convert/url").Param("url", url)
	return r
}
...
func (r *Chromium) ConvertMarkdown(ctx context.Context, html io.Reader) *Chromium {
	r.Req = r.Client.MultipartRequest(ctx, httpclient.POST, "/forms/chromium/convert/markdown").File("files", "index.html", html)
	return r
}
...
func (r *Chromium) ScreenshotURL(ctx context.Context, url string) *Chromium {
	r.Req = r.Client.MultipartRequest(ctx, httpclient.POST, "/forms/chromium/screenshot/url").Param("url", url)
	return r
}
...
func (r *Chromium) ScreenshotHTML(ctx context.Context, html io.Reader) *Chromium {
	r.Req = r.Client.MultipartRequest(ctx, httpclient.POST, "/forms/chromium/screenshot/html").File("files", "index.html", html)
	return r
}
...
func (r *Chromium) ScreenshotMarkdown(ctx context.Context, html io.Reader) *Chromium {
	r.Req = r.Client.MultipartRequest(ctx, httpclient.POST, "/forms/chromium/screenshot/markdown").File("files", "index.html", html)
	return r
}
